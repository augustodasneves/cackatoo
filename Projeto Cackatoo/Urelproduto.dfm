  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Agropecu'#225'ria e Ferragem Lima Neves - Relat'#243'rio de Produtos'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clNavy
        Font.Height = -11
    ...
    object QRBand4: TQRBand
      ...
      object lbltotal_valor: TQRLabel
        Left = 288
        Top = 8
        Width = 138
        Height = 17
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      'from produto,fornecedor,categoria,funcionarios'
        ...
        'where produto.fornecedor_id_fornecedor = fornecedor.id_fornecedo' +
        'r'
    ...
    object ADOQuery1valor_venda: TBCDField
      FieldName = 'valor_venda'
      Precision = 10
      Size = 2
    end
    object ADOQuery1data_modificacao: TDateField
      FieldName = 'data_modificacao'
    end
    object ADOQuery1valor_forn: TBCDField
      FieldName = 'valor_forn'
      Precision = 10
      Size = 2
    end
    object ADOQuery1qtd: TIntegerField
      FieldName = 'qtd'
    end
    object ADOQuery1uni_medida: TStringField
    ...
    object ADOQuery1estoque_minimo: TIntegerField
      FieldName = 'estoque_minimo'
    end
    object ADOQuery1perecivel: TSmallintField
      FieldName = 'perecivel'
    end
    object ADOQuery1prazo_validade: TDateField
      FieldName = 'prazo_validade'
    end
    object ADOQuery1cor: TStringField
      FieldName = 'cor'
      Size = 30
    end
    ...
    object ADOQuery1nome_funcionario: TStringField
      FieldName = 'nome_funcionario'
      Size = 100
    end
    object ADOQuery1categoria: TStringField
      FieldName = 'categoria'
      Size = 100
    end
  end
